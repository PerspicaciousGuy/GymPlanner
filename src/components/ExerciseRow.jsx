        ...
        <ContextMenu>
          <ContextMenuTrigger asChild>
            <div className="p-4 bg-white border-b border-slate-50 last:border-b-0 space-y-4 group/card relative">
              ...
              {showHistoryRow && (
                <div className="mt-2 p-3.5 bg-slate-50/50 rounded-[1.5rem] border border-slate-100/50 space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-400">
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-1.5 text-[10px] text-slate-500 font-bold">
                      <History size={12} className="text-slate-300 shrink-0" />
                      <span className="truncate">
                        {formatDateCompact(previousEntry.date)}: {previousSummary}
                      </span>
                    </div>
                    {occurrenceCount > 0 && (
                      <div className="bg-indigo-50/50 text-indigo-500 font-black px-1.5 py-0.5 rounded text-[8px] uppercase tracking-tighter border border-indigo-100/30 shrink-0">
                  ...
                  {appliedHistoryDate !== previousEntry.date && (
                    <Button
                      ...
                      variant="outline"
                      className="w-full h-10 border-indigo-100 bg-white text-indigo-600 rounded-2xl text-[9px] font-black uppercase tracking-[0.2em] hover:bg-indigo-50 hover:text-indigo-700 transition-all shadow-sm"
                    >
                      Apply Last Values
                    </Button>
                  )}
